...
export default function LightHotFont({
  ...
  return (
    ...
    >
      ...
      <G>
        <Path
          d="M298 151C316.225 151 331 165.775 331 184C331 202.225 316.225 217 298 217C279.775 217 265 202.225 265 184C265 165.775 279.775 151 298 151Z"
          fill="url(#sunOuter)"
        />
      ...
      <Defs>
        ...
        <RadialGradient
          ...
          r={1}
          gradientUnits="userSpaceOnUse"
          gradientTransform="translate(298 184) rotate(90) scale(76)"
        >
          <Stop offset={0} stopColor="#FBBF24" stopOpacity={0.28} />
          <Stop offset={0.28} stopColor="#FDE68A" stopOpacity={0.2} />
          <Stop offset={0.6} stopColor="#FEF3C7" stopOpacity={0.12} />
